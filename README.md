...
# <!-- BUILD\_VERSION --> \*\*Build Version:\*\* 0.6.2-beta (2026-02-15 22:13:27)
...
# \- \*\*File Output\*\*: `Export/nanovna\_YYYYMMDD\_HHMMSS\_startfreq\_endfreq\_step.brl`
...
# \- See WEB\_INTERFACE\_DEBUGGING.md for complete guide

# \- German guide: WEB\_INTERFACE\_DEBUGGING\_DE.md
...
# \- `command\_templates.cfg` - NanoVNA commands

# \- `app\_settings.cfg` - Application settings (auto-saved)

# 

# \*\*Logs:\*\* `logs/`

# \- `debug\_YYYYMMDD\_HHMMSS.txt` - General debug log

# \- `debug\_comm\_YYYYMMDD\_HHMMSS.txt` - Serial communication log

# 

# \*\*Exports:\*\* `Export/`

# \- `nanovna\_YYYYMMDD\_HHMMSS\_startfreq\_endfreq\_step.csv` - CSV data export

# \- `nanovna\_YYYYMMDD\_HHMMSS\_startfreq\_endfreq\_step.txt` - Text export

# \- `nanovna\_YYYYMMDD\_HHMMSS\_startfreq\_endfreq\_step.brl` - Braille graphics export
