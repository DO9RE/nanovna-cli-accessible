...
### Smith-Diagramm-Visualisierung:

Erleben Sie Impedanzanpassung durch 3D-Raumaudio-Darstellung des Smith-Diagramms.
**SIE** stehen im Zentrum des Smith-Diagramms (perfekte 50Ω-Anpassung).
Messpunkte bewegen sich in 3D um Sie herum.

**Was ist Smith-Diagramm-Visualisierung?**
- Akustische Darstellung des Smith-Diagramms mittels Raumaudio
- Zeigt Impedanzposition im Stereo- oder Surround-Feld (7.1/5.1/2.0)
- Zentrum (SIE) = perfekte 50Ω-Anpassung, Rand = schlechte Anpassung
- Vorne-Position = induktive Reaktanz (Antenne zu kurz)
- Hinten-Position = kapazitive Reaktanz (Antenne zu lang)

**Audio-Hardware-Unterstützung:**
Die Anwendung erkennt automatisch Ihre Audio-Hardware-Fähigkeiten:
- **Stereo (2.0):** Psychoakustische 3D-Simulation mit Crossfeed für Vorne/Hinten
- **5.1 Surround:** Front-, Rear- und Center-Lautsprecher für echtes räumliches Audio
- **7.1 Surround:** Vollständiges 360°-Raumaudio mit Seitenlautsprechern
- **Dolby Atmos:** Höhenkanäle (erkannt, aber noch nicht verwendet)

Für beste Smith-Diagramm-Ortung verwenden Sie ein 7.1- oder 5.1-Surround-Headset!
**NEU:** Für Stereo-Kopfhörer: Psychoakustische Verarbeitung simuliert 3D!

**Smith-Visualisierung aktivieren:**
1. Akustischen Analysemodus betreten (**A**)
2. Taste **V** drücken zum Ein-/Ausschalten der Smith-Visualisierung
3. Taste **B** drücken zum Auswählen des Visualisierungsmodus (1-6)
4. Taste **H** drücken für Smith-spezifische Hilfe
5. **C** → **Smith Audio** drücken zum Konfigurieren der Surround-Parameter
6. **NEU: C** → **W** drücken für den Räumlichen Audio-Kalibrierungs-Assistenten!

**═══════════════════════════════════════════════════════════**
**NEU: Räumlicher Audio-Kalibrierungs-Assistent (Taste W)**
**═══════════════════════════════════════════════════════════**

Der interaktive Kalibrierungs-Assistent optimiert räumliches Audio für Ihr Gehör!

**Der Assistent:**
- Erkennt Ihre Audio-Hardware (Stereo vs. Surround)
- Passt sich an Ihre verfügbaren Funktionen an
- Testet Ihre Richtungswahrnehmung (L/R, V/H, diagonal)
- Kalibriert Nah/Fern-Wahrnehmung
- Ermittelt Ihre Lautstärkepräferenzen
- Lässt Sie Klangtypen mit Vorschau wählen
- Optimiert psychoakustische Parameter (nur Stereo-Modus)

**Für Stereo-Nutzer:**
- Crossfeed-Menge für V/H-Unterscheidung
- Rückseitige Dämpfung für Distanz-Simulation
- Seitenbetonung für bessere L/R-Ortung

**Für Surround-Nutzer:**
- Vollständige 8-Richtungs-Tests (V/H/L/R + Diagonalen)
- Lautsprecher-Entfernungs-Kalibrierung
- Kanalbalance-Optimierung

**Dauer:** 10-15 Minuten
**Empfohlen:** Führen Sie dies einmal durch für optimale Ergebnisse!
**Zugriff:** Audio-Konfiguration (A → C → W)

Die Einstellungen werden persistent gespeichert und auf alle räumlichen
Audio-Funktionen angewendet.

**═══════════════════════════════════════════════════════════**
**Sechs Visualisierungsmodi (Alle vollständig implementiert!):**
**═══════════════════════════════════════════════════════════**

**1. KARTESISCH (Am einfachsten - Empfohlen für Anfänger)**
   - Position im rechteckigen 3D-Raum
   - Re(Γ) → Links/Rechts-Achse
   - Im(Γ) → Vorne/Hinten-Achse
   - Sie stehen im Zentrum, Sound bewegt sich im Rechteckmuster
   - **Am besten für:** Smith-Diagramm-Grundlagen lernen

**2. POLAR (Fortgeschritten - Natürliche Smith-Struktur)**
   - Sound rotiert um Sie im Kreis
   - Winkel ∠Γ → Richtung um Sie (0°=vorne, ±180°=hinten)
   - Betrag |Γ| → Entfernung von Ihnen (näher=bessere Anpassung)
   - Sound kreist im/gegen Uhrzeigersinn über Frequenz
   - **Am besten für:** Kabel-Analyse, Rotationsmuster erkennen

**3. IMPEDANZ DIREKT (Einfach - Kein Smith-Wissen erforderlich)**
   - Direkte Abbildung von R und X
   - R (Widerstand) → L/R (0Ω links, 50Ω Mitte, 200Ω rechts)
   - X (Reaktanz) → V/H (+200Ω vorne, 0Ω Mitte, -200Ω hinten)
   - Keine Gamma-Konversion, direkte Impedanz-Wahrnehmung
   - **Am besten für:** Anfänger ohne Smith-Erfahrung

**4. SWR-KREISE (Zielorientiert - Beste Anpassung finden)**
   - Fokus auf SWR-Qualität, radiale Positionierung
   - Sound-Entfernung von Ihnen = SWR-Level
   - Nah bei Ihnen = Gute Anpassung (niedriges SWR)
   - Weit von Ihnen = Schlechte Anpassung (hohes SWR)
   - Lautstärke steigt mit schlechterem SWR
   - **Am besten für:** Antennen-Abstimmung, Resonanz finden

**5. ZEITDOMÄNE MIT CUES (Hybrid - Frequenz + Smith-Kontext)**
   - Standard-Frequenz-Sweep mit subtilen Smith-Cues
   - Primär: Frequenz-Fortschritt (links nach rechts)
   - Sekundär: Subtile Smith-Positions-Cues (V/H, Lautstärke)
   - **Am besten für:** Nutzer, die Akustik-Modus mögen, aber Smith-Kontext wollen

**6. HYBRID MULTI (Experte - Maximale Information)**
   - Mehrere simultane Audio-Ebenen
   - Ebene 1: Polare Positionierung (Haupt-Räumliches-Cue)
   - Ebene 2: SWR-Information (Lautstärke-Modulation)
   - Ebene 3: Ereignis-Marker (Achsenkreuzungen, Resonanz)
   - Kombiniert das Beste aller Modi
   - **Am besten für:** Erfahrene Nutzer, komplexe Analyse

**Surround-Sound-Konfiguration:**
Im Audio-Konfigurationsmenü **S** drücken (verfügbar für alle Hardware-Typen):
- **Stereo-Modus:** Crossfeed, Rückseitige Dämpfung, Seitenbetonung
- **Surround-Modus:** Front-/Rück-/Seitenentfernung, Center-Stärke, etc.
- **Front-/Rück-/Seitenentfernung:** Wahrgenommene Lautsprecherentfernung (50-200%)
- **Center-Kanal-Stärke:** Center-Lautsprecher-Prominenz (0-100%)
- **V/H-Trennung:** Vorne/Hinten-Unterscheidung verbessern (50-200%)
- **Seiten-Betonung:** 90°-Ortung verbessern (50-200%)
- **Fading-Kurven:** Räumliche Bewegungswahrnehmung wählen:
  - Linear: Gleichmäßige wahrgenommene Bewegung (Standard)
  - Logarithmisch: Mehr Betonung auf Zentrum
  - Exponentiell: Mehr Betonung auf Randpositionen
  - Sinus: Glatte, natürliche Übergänge

**Smith-Audio-Eigenschaften:**
- Subtiles rosa Umgebungsrauschen im Stereofeld positioniert
- Lautstärke: 30% der Hauptkurven (konfigurierbar)
- Funktioniert am besten mit Kopfhörern
- Räumliche Position zeigt Impedanzlage
- Sound bewegt sich zum Zentrum bei Annäherung an Resonanz
- **NEU:** Psychoakustische Verbesserungen für Stereo-Kopfhörer

**Tipps für Smith-Visualisierung:**
- Beginnen Sie mit Modus 1 (Kartesisch) oder 3 (Impedanz Direkt)
- Nutzen Sie Kopfhörer für beste Raumaudio-Erfahrung
- Smith-Hinweise funktionieren am besten im glatten Wiedergabemodus
- **NEU:** Führen Sie den Kalibrierungs-Assistenten aus (W-Taste) für optimale Ergebnisse!
- Smith-Visualisierung nach Start der Wiedergabe aktivieren
- Drücken Sie **H** während Smith aktiv für detaillierte Hilfe
- Hören Sie auf Bewegung zum Zentrum (sich verbessernde Anpassung)
- Vorne/Hinten-Position zeigt reaktive Komponente an

**Beispiel-Interpretationen:**
- **Zentrums-Sound** = Perfekte 50Ω-Anpassung (SIE sind hier!)
- **Sound bewegt sich zum Zentrum** = Nähert sich Resonanz
- **Sound vorne** = Induktive Reaktanz (Antenne zu kurz)
- **Sound hinten** = Kapazitive Reaktanz (Antenne zu lang)
- **Sound am Rand** = Hohes SWR, schlechte Impedanzanpassung
- **Sound kreist um Sie** = Frequenz-Sweep über reaktives Bauteil

**📖 Detaillierte Informationen zu den Smith-Diagramm-Modi:**

Für eine ausführliche Beschreibung aller sechs Visualisierungsmodi, der räumlichen Relationen und der Listener-Event-Beziehungen, siehe die separate Datei:
- **smith_modi_beschreibung.md** (im doc-Verzeichnis)
- Enthält detaillierte technische Erklärungen jedes Modus
- Beschreibt Achsenkreuzungen und Bewegungsmuster
- Gibt Tipps für blinde Benutzer zur räumlichen Orientierung
- Diese Datei bleibt als Schnellreferenz verfügbar
...
**Smith:** V (Visualisierung umschalten), B (Modus wechseln 1-6)  
**Werkzeuge:** Y (Y-Lineal), X (X-Lineal), N (Statuszeile), G (gehe zu), A (Audio-Konfig), M (messen), E (exportieren), H (Hilfe)
