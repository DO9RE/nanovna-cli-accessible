...
/**
 * Linux implementation of console input using termios
 */
class ConsoleInputLinux : public IConsoleInput {
private:
    struct termios original_termios;
    bool initialized;
    
public:
    ConsoleInputLinux() : initialized(false) {}
    
    ~ConsoleInputLinux() override {
        cleanup();
    }
